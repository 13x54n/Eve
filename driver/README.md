...
Expo SDK 57 driver app (`ca.sherpafoods.evedriver`). File-based routes live in `src/app`. This app uses Mapbox, document upload, and `expo-dev-client` — use a development build, not Expo Go.
