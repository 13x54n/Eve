...
export default function MenuScreen() {
  ...
  const walletToolRows: MenuRow[] = [
    {
      icon: 'repeat',
      title: 'Token Swap',
      detail: 'Manual token swaps on testnet via Privy',
      onPress: () => router.push('/swap' as Href),
    },
  ];
  ...
  return (
    <View style={[styles.safeArea, { backgroundColor: brand.canvas, paddingTop: insets.top }]}>
      <ScrollView
        style={{ flex: 1 }}
      ...
      > 
        ...
        >
          ...
          <SettingsSection title="Wallet Tools" rows={walletToolRows} />
