      ...
      <View style={styles.card}>
        <View style={styles.row}>
          <View style={styles.copy}>
            <Text style={styles.rowTitle}>{saving ? "Saving..." : "Trip and offer alerts"}</Text>
            <Text style={styles.rowDetail}>Push updates for rides and offers</Text>
          </View>
          <Switch
            value={enabled}
            ...
            accessibilityLabel="Trip and offer alerts"
          />
        </View>
      </View>
    </View>
