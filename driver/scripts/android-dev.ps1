# Android development setup script for Eve Driver (Windows PowerShell)
# Sets up adb reverse for Metro bundler and starts Expo

$ErrorActionPreference = "Stop"

Write-Host "🔧 Eve Driver - Android Development Setup" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "   - Subsequent: Open 'Eve Driver' app on your device"
Write-Host ""
